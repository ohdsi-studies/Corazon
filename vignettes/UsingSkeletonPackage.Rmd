...
Please copy the `corazon` folder. Choose a name for your study package, and change all references from 'corazon' to your name of choice in the package code. You could use Notepad++'s 'Find in files' option to do this automatically.
